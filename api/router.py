...
from api.v1 import analysis, auth, quotes, line_items, estimator, pdf, suppliers, chat, floor_plan, boq
...
router.include_router(floor_plan_router, prefix="/floor-plan", tags=["Floor Plan"])
